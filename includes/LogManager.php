<?php
	class LogManager
	{
		...
		static function LogError($errorMessage, $fromFunc="", $sql="", $link="")
		{
			...
			//$filePath = 'C:/wamp64/www/plantsandplanter/includes/san_mounted/Logs/Errors'.$txtFile.'.txt';
			$filePath = 'C:/wamp64/www/plantsandplanter/Logs/Errors'.$txtFile.'.txt';
		...
		static function LogTestString($message)
		{
			...
			$filePath = 'C:/wamp64/www/plantsandplanter/Logs/Tests/testlog.txt';
