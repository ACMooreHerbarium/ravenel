...
class Specimen extends Exception {
	...
	*/
	public function renderSimilarSpecimens() {
		...
		{
			$results .= '<div class="text-center"><a href="'.ROOT_FOLDER.'viewer.php?type=specimen&institute=Carolina&number='.$otherCatalogNumbers.'"><img src="'.$thumbnailurl.'" class="img-responsive center-block" alt="Catalog #'.$otherCatalogNumbers.'"></a></div>';
		}
