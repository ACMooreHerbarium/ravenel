...
class Manuscript extends Exception
{
	...
	public function __construct($pointer, $institute)
	{
		...
		{
			$this->thumb = "https://digital.tcl.sc.edu/utils/getthumbnail/collection/".$this->alias."/id/".$location;
			$this->image = "https://digital.tcl.sc.edu/utils/ajaxhelper/?CISOROOT=".$this->alias."&CISOPTR=".$location."&action=2";
		}
