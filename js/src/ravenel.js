...
(function ($) {
	...
	var Search = function (isResults) {
		if(isResults)
		{
			...
			//here is where we initalize the photograph
			$.ajax({
				...
				success: function (result) {
					...
					{
						$('#photographs').html("No portraits matched the search criteria.");
					}
...
$(document).ready(function () {
	//this fixes the isses on the view page an anywhere where the bootstrap picture viewer is used
	$(document).on('click',"a[href='#zoom-in']",function(){
		$(".img-responsive").each(function(){
			$(this).css("width","");
			$(this).css("height","");
		});
	});
	$(document).on('click',"a[href='#zoom-out']",function(){
		$(".img-responsive").each(function(){
			$(this).css("width","");
			$(this).css("height","");
		});
